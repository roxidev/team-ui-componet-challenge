...
<div className='flex flex-wrap gap-3'>
            ...
            {/* ==============Primary button=============== */}
            <button className=' py-1.5 px-5 bg-primary rounded-md font-medium text-white hover:bg-hover-primary focus:bg-hover-primary active:bg-active-primary'>Primary</button>
            {/* ==============secondary button=============== */}
            <button className=' py-1.5 px-5 bg-secondary rounded-md font-medium text-white hover:bg-hover-secondary  focus:bg-hover-secondary active:bg-active-secondary'>Secondary</button>
            {/* ==============info button=============== */}
